...
// It is not done by default because they are many perfectly useful way of altering render state for imgui contents (e.g. changing shader_set/blending settings before an Image call).
